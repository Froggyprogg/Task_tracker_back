...
var file_api_user_v1_service_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x48, 0x75, 0x6d, 0x61, 0x6e, 0x22,
	...
	0x6e, 0x66, 0x6f, 0x32, 0x3a, 0x0a, 0x06, 0x55, 0x73, 0x65, 0x72, 0x56, 0x31, 0x12, 0x30, 0x0a,
...
var file_api_user_v1_service_proto_goTypes = []interface{}{
	...
	(*GetRequest)(nil),  // 1: user_v1.GetRequest
	(*GetResponse)(nil), // 2: user_v1.GetResponse
}
var file_api_user_v1_service_proto_depIdxs = []int32{
	0, // 0: user_v1.GetResponse.info:type_name -> user_v1.UserInfo
	1, // 1: user_v1.UserV1.Get:input_type -> user_v1.GetRequest
	2, // 2: user_v1.UserV1.Get:output_type -> user_v1.GetResponse
